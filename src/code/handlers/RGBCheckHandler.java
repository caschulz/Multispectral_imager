...
/**
 * Handler for the case where a RGB check box has been selected. Adds the file name and label
 ...
 *
 */
public class RGBCheckHandler implements ActionListener {
	/**
	 ...
	 */
	public RGBCheckHandler(ArrayList<String> names, ArrayList<String> labels, JCheckBox box, String f) {
		_names = names;
		_box = box;
		_labels = labels;
		_file = f+".jpg";
